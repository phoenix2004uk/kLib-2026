...
//	body: Minmus
//	eccentricity: < 0.003
//	inclination: 79.2 - 79.8
//	altitude: 150km max
// Start scan with AG1
local targetBody is Minmus.
local launchApoapsis is 100e3.
local launchInclination is 0.
local minApoapsis is 149e3.
local maxApoapsis is 150e3.
local minInclination is 79.2.
local maxInclination is 79.8.
local maxEccentricity is 0.003.
