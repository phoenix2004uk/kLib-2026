...
local function TrueAnomalyEtaAN {
...
local function TrueAnomalyEtaDN {
	parameter w is orbit:argumentOfPeriapsis,
		P is orbit:period,
		V0 is orbit:trueanomaly,
		e is orbit:eccentricity.
...
local function TrueAnomalyEtaHyperbolic {
...
local function TrueAnomalyEtaHyperbolicAN {
	parameter w is orbit:argumentOfPeriapsis,
		V0 is orbit:trueanomaly,
		a is orbit:semimajoraxis,
		e is orbit:eccentricity,
...
local function TrueAnomalyEtaHyperbolicDN {
	parameter w is orbit:argumentOfPeriapsis,
		V0 is orbit:trueanomaly,
		a is orbit:semimajoraxis,
		e is orbit:eccentricity,
...
global OrbitalMechanics is lex(
	"v", OrbitalSpeed@,
