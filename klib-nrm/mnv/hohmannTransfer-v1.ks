{
	...
	export({
		...
		local transferAngle is mod(180-targetAngularSpeed*OrbitalMechanics:P((targetRadiusEstimate+shipRadiusEstimate)/2)/2,360).
		...
		if targetRadiusEstimate>shipRadiusEstimate and phaseAngle<transferAngle set phaseAngle to phaseAngle+360.
